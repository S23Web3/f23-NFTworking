...
contract MoodNft is ERC721, Ownable {
    ...
    //The caller of the Ownable is apparently automatic msg.sender
    ...
    function flipMood(uint256 tokenId) public {
        ...
        //i put it explicit after the bug, yet it does not even go anywhere near the else if...
        if (s_tokenIdToState[tokenId] == NFTState.SAD) {
            s_tokenIdToState[tokenId] == NFTState.HAPPY;
        } else if (s_tokenIdToState[tokenId] == NFTState.HAPPY) {
